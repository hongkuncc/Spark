package com.hongkuncc.mock

import java.util.Properties

import com.hongkuncc.common.bean.CityInfo
import com.hongkuncc.mock.util.RandomNumUtil
import com.hongkuncc.sparkmall.mock.util.RandomOptions
